...
- beveled_wall_corner: islands=1, rails=5, stitched=2, blocked=0, self_seam_chains=0, improvisations=2, ambiguities=4
- l_corridor_tunnel_seamed_folds: islands=1, rails=5, stitched=2, blocked=0, self_seam_chains=0, improvisations=2, ambiguities=4
- cylinder_tube_two_seams: islands=1, rails=4, stitched=1, blocked=0, self_seam_chains=0, improvisations=2, ambiguities=4
- tube_with_cap: islands=2, rails=5, stitched=0, blocked=1, self_seam_chains=1, improvisations=5, ambiguities=5
- detached_parallel_walls: islands=2, rails=4, stitched=0, blocked=0, self_seam_chains=0, improvisations=4, ambiguities=2
