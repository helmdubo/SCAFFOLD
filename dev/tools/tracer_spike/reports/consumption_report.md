...
- beveled_wall_corner: islands=1, rails=5, stitched=2, blocked=0, self_seam_chains=0, axis_families=5, inner_chains=0/0, inner_fallback_vertices=0, solve_residuals=(A:0.0, B:0.0), both_pct=100.0, residuals=(0.0,0.0), unconstrained=0, degenerate_islands=0, axis_coords=(both:100.0%, one:0.0%, zero:0.0%), improvisations=2, ambiguities=1
- l_corridor_tunnel_seamed_folds: islands=1, rails=5, stitched=2, blocked=0, self_seam_chains=0, axis_families=5, inner_chains=0/0, inner_fallback_vertices=0, solve_residuals=(A:0.0, B:0.0), both_pct=100.0, residuals=(0.0,0.0), unconstrained=0, degenerate_islands=0, axis_coords=(both:100.0%, one:0.0%, zero:0.0%), improvisations=2, ambiguities=1
- cylinder_tube_two_seams: islands=1, rails=4, stitched=1, blocked=0, self_seam_chains=0, axis_families=6, inner_chains=0/0, inner_fallback_vertices=0, solve_residuals=(A:0.0, B:0.0), both_pct=100.0, residuals=(0.0,0.0), unconstrained=0, degenerate_islands=0, axis_coords=(both:100.0%, one:0.0%, zero:0.0%), improvisations=2, ambiguities=2
- tube_with_cap: islands=2, rails=5, stitched=0, blocked=1, self_seam_chains=1, axis_families=14, inner_chains=0/0, inner_fallback_vertices=0, solve_residuals=(A:0.0, B:0.0), both_pct=100.0, residuals=(0.0,0.0), unconstrained=0, degenerate_islands=0, axis_coords=(both:100.0%, one:0.0%, zero:0.0%), improvisations=5, ambiguities=10
- detached_parallel_walls: islands=2, rails=4, stitched=0, blocked=0, self_seam_chains=0, axis_families=8, inner_chains=0/0, inner_fallback_vertices=0, solve_residuals=(A:0.0, B:0.0), both_pct=100.0, residuals=(0.0,0.0), unconstrained=0, degenerate_islands=0, axis_coords=(both:100.0%, one:0.0%, zero:0.0%), improvisations=4, ambiguities=4
- wall_with_window_spike: islands=1, rails=3, stitched=0, blocked=0, self_seam_chains=0, axis_families=8, inner_chains=1/1, inner_fallback_vertices=0, solve_residuals=(A:0.0, B:0.0), both_pct=50.0, residuals=(0.0,0.0), unconstrained=1, degenerate_islands=0, axis_coords=(both:50.0%, one:50.0%, zero:0.0%), improvisations=2, ambiguities=2
- t_junction_walls: islands=1, rails=7, stitched=2, blocked=0, self_seam_chains=0, axis_families=7, inner_chains=0/0, inner_fallback_vertices=0, solve_residuals=(A:0.0, B:0.0), both_pct=100.0, residuals=(0.0,0.0), unconstrained=0, degenerate_islands=0, axis_coords=(both:100.0%, one:0.0%, zero:0.0%), improvisations=5, ambiguities=1
