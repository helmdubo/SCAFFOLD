...
def main() -> None:
    ...
    console_block = layout.get("console_diagnostics_block")
    if console_block:
        print(console_block)
    print(report)
...
def build_blender_report(
    ...
    console_diagnostics_block = layout.get("console_diagnostics_block") or "ARCHITECT SUMMARY\nunavailable"
