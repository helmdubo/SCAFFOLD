...
Implemented SideSurfaceContinuityEvidence v0:
  ...
  endpoint occurrences at one existing ScaffoldNode.

Approved SideSurfaceContinuityEvidence v1 contract, not yet implemented:
  v0 plus a direction/flow-family compatibility gate.
