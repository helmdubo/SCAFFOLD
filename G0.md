# Scaffold Core — G0 v1.4

> **Immutable B-rep-inspired Interpretation Pipeline**

**Status:** architectural contract v1.4
...
- l_corridor_tunnel_seamed_folds: one length family across floor, wall
  and ceiling; one width family;
- beveled_wall_corner: one horizontal family across wall A, chamfer and
  wall B; one vertical family;
...
- two runs meeting at a junction (ScaffoldNode or RunEndpointJunction)
  ...
  within GEODESIC_STRAIGHT_TOLERANCE of pi;
