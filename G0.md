# Scaffold Core — G0 v1.3

> **Immutable B-rep-inspired Interpretation Pipeline**

**Status:** architectural contract v1.3
...
ConnectedDirectionFamily
  approved DD-43 v0 contract, implementation pending: connectivity-propagated
  direction-family evidence over PatchChainDirectionalEvidence and
  ScaffoldGraph, with signed-dihedral parallel transport across patch
  boundaries. It is not AlignmentClass identity and not a trace/rail choice.
