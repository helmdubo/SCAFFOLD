...
Rules:
- Synthetic single-patch source fixture only.
...
def make_single_quad_source() -> SourceMeshSnapshot:
    """Return one quad face with four boundary edges."""
