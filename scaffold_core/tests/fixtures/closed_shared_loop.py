...
def make_closed_shared_boundary_loop_source() -> SourceMeshSnapshot:
    ...
    return SourceMeshSnapshot(
        ...
        edges={
            e10: MeshEdgeRef(e10, (v0, v1)),
            e9: MeshEdgeRef(e9, (v1, v2)),
            e6: MeshEdgeRef(e6, (v2, v3)),
            e7: MeshEdgeRef(e7, (v3, v0)),
            e0: MeshEdgeRef(e0, (v4, v5)),
            e1: MeshEdgeRef(e1, (v5, v6)),
            e2: MeshEdgeRef(e2, (v6, v7)),
            e3: MeshEdgeRef(e3, (v7, v4)),
            e4: MeshEdgeRef(e4, (v0, v4)),
            e5: MeshEdgeRef(e5, (v1, v5)),
            e8: MeshEdgeRef(e8, (v2, v6)),
            e11: MeshEdgeRef(e11, (v3, v7)),
        },
        faces={
            f0: MeshFaceRef(f0, (v0, v1, v2, v3), (e10, e9, e6, e7)),
            f1: MeshFaceRef(f1, (v0, v4, v5, v1), (e4, e0, e5, e10)),
            f2: MeshFaceRef(f2, (v1, v5, v6, v2), (e5, e1, e8, e9)),
            f3: MeshFaceRef(f3, (v2, v6, v7, v3), (e8, e2, e11, e6)),
            f4: MeshFaceRef(f4, (v3, v7, v4, v0), (e11, e3, e4, e7)),
            f5: MeshFaceRef(f5, (v4, v7, v6, v5), (e3, e2, e1, e0)),
        },
        selected_face_ids=(f0, f1, f2, f3, f4, f5),
        marks=(
            SourceMark(kind=SourceMarkKind.SEAM, target_id=e10),
            SourceMark(kind=SourceMarkKind.SEAM, target_id=e9),
            SourceMark(kind=SourceMarkKind.SEAM, target_id=e6),
            SourceMark(kind=SourceMarkKind.SEAM, target_id=e7),
        ),
    )
