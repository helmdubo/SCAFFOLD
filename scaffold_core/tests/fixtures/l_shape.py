...
def make_two_patch_source_with_two_edge_seam_run() -> SourceMeshSnapshot:
    """Return two polygon faces sharing a seam boundary split into two source edges."""
    ...
    return SourceMeshSnapshot(
        id=SourceMeshId("two_patch_two_edge_seam_run"),
        vertices={
            v0: MeshVertexRef(v0, (0.0, 0.0, 0.0)),
            v1: MeshVertexRef(v1, (1.0, 0.0, 0.0)),
            v2: MeshVertexRef(v2, (1.0, 0.5, 0.0)),
            v3: MeshVertexRef(v3, (1.0, 1.0, 0.0)),
            v4: MeshVertexRef(v4, (0.0, 1.0, 0.0)),
            v5: MeshVertexRef(v5, (2.0, 0.0, 0.0)),
            v6: MeshVertexRef(v6, (2.0, 1.0, 0.0)),
        },
        edges={
            e0: MeshEdgeRef(e0, (v0, v1)),
            e1: MeshEdgeRef(e1, (v1, v2)),
            e2: MeshEdgeRef(e2, (v2, v3)),
            e3: MeshEdgeRef(e3, (v3, v4)),
            e4: MeshEdgeRef(e4, (v4, v0)),
            e5: MeshEdgeRef(e5, (v1, v5)),
            e6: MeshEdgeRef(e6, (v5, v6)),
            e7: MeshEdgeRef(e7, (v6, v3)),
        },
        faces={
            f0: MeshFaceRef(f0, (v0, v1, v2, v3, v4), (e0, e1, e2, e3, e4)),
            f1: MeshFaceRef(f1, (v1, v5, v6, v3, v2), (e5, e6, e7, e2, e1)),
        },
        selected_face_ids=(f0, f1),
        marks=(
